    ...
    <div class="card text-white md:w-[720px] w-[320px] bg-black/20 p-4 mb-4 rounded">
        <form method="POST" action="{{ url('pets/' . $pet->id) }}" class="flex flex-col md:flex-row gap-4 mt-4"
            ...
            <div class="w-full md:w-[320px]">
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="name" placeholder="pepinillo"
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="kind" placeholder="Dog"
                ...
                <input type="number" class="input bg-[#0009] outline-0" name="weight" placeholder="10.5"
                    value="{{ old('weight', $pet->weight) }}" step="0.1">
                @error('weight')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                {{-- Age --}}
                <label class="label text-white">Age:</label>
                <input type="number" class="input bg-[#0009] outline-0" name="age" placeholder="5"
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="breed" placeholder="Golden Retriever"
            ...
            <div class="w-full md:w-[320px]">
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="location" placeholder="City, Country"
                ...
                <input type="text" class="input bg-[#0009] outline-0" name="description" placeholder="Description"
                ...
                <select name="active" id="" class="input bg-[#0009] outline-0">
                    <option value="1" {{ $pet->active == 1 ? 'selected' : '' }}>Active</option>
                    <option value="0" {{ $pet->active == 0 ? 'selected' : '' }}>Inactive</option>
                </select>
                @error('active')
                    <small class="badge badge-error w-full mt-1 text-xs py-4">{{ $message }}</small>
                @enderror
                ...
                <select name="status" id="" class="input bg-[#0009] outline-0">
                    ...
                    <option value="0" {{ $pet->status == 0 ? 'selected' : '' }}>Not Available</option>
                </select>
                @error('status')
